...
class AnswersGenerator:
    ...
    def __init__(self, generator_path: str, tokenizer_path: str):
    ...
    def run_inference(self, prompts_path: str, num_answers: int, output_path: str) -> None:
        """Method for running inferences on prompts stored within a JSON file."""

        with open(prompts_path, 'r') as f:
            prompts = json.load(f)

        answers = self.generate_answers(prompts, num_answers)
